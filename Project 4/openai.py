...
'''ref https://github.com/hiive/hiivemdptoolbox/blob/dd44587196f698ecbe34ab51eed3b13051e82c1b/hiive/mdptoolbox/openai.py#L8'''
class OpenAI_MDPToolbox:
    ...
    def colors(self):
        return {b'S': 'gray', b'F': 'linen', b'H': 'steelblue', b'G': 'olive',}
